...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <div title="博客管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('博客列表','blogList.jsp','icon-writeblog')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">写博客</a>
            <a href="javascript:openTab('博客分类','blogCategory.jsp','icon-bkgl')" class="easyui-linkbutton"
...
<div region="south" style="height: 25px;padding: 5px;overflow: hidden;" align="center">
    Copyright © 2012-2017 lichongsky的SSM博客系统 版权所有
</div>
<script>
    /**
     * 打开选项卡
